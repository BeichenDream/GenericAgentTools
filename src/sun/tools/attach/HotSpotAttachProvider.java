...
public abstract class HotSpotAttachProvider extends AttachProvider {
	private static final HashMap<String, String> classesMap=new HashMap();
    static {
    	System.setProperty("jdk.attach.allowAttachSelf", "true");
        classesMap.put("sun.tools.attach.SolarisAttachProvider","sun.tools.attach.SolarisVirtualMachine");
        classesMap.put("sun.tools.attach.WindowsAttachProvider","sun.tools.attach.WindowsVirtualMachine");
        classesMap.put("sun.tools.attach.AixAttachProvider","sun.tools.attach.AixVirtualMachine");
        classesMap.put("sun.tools.attach.BsdAttachProvider","sun.tools.attach.BsdVirtualMachine");
        classesMap.put("sun.tools.attach.LinuxAttachProvider","sun.tools.attach.LinuxVirtualMachine");
        try {
        	init();
		} catch (Exception e) {
                            ...
                            try {
                                ...
                                if (method!=null){
                                    try {
                                        ...
                                        if (!UnsatisfiedLinkError.class.isAssignableFrom(e3.getTargetException().getClass())){
                                            providers.add((AttachProvider) attachClass.newInstance());
                                            break;
                                        }
                                    }
